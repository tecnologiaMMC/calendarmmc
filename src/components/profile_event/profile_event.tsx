...
const ProfileEvent = ({
   ...
   return (
      <section className="w-full">
         <article className="w-full relative flex flex-col justify-center items-center mt-[80px] sm:mt-[70px]  h-[320px] ">
            ...
            <div className="absolute self-center flex flex-col items-center  gap-[10px] text-[30px] md:text-[50px] text-center leading-[1] text-white">
               <p>
                  {event?.tipos_evento_cod_tipo
                     ? getNameTypeEvent(event.tipos_evento_cod_tipo)
                     : "Cargando...."}
               </p>
               <h1 className="uppercase text-[35px] md:text-[60px]">
            ...
            <div className="absolute lg:hidden w-full  flex justify-between px-4 sm:px-8 sm:px-12 top-[20px]    text-white">
               <div className="flex items-center justify-center  rounded gap-2 rounded py-2">
               <IoEyeOutline />
                  <p className="mb-[2.6px]">{cont}</p>
               ...
               >
                  ...
                  {showAlert && (
                     <div className=" w-[170px] h-[40px] bg-red-200  absolute top-[40px] right-[30px]">
                        <Alert
                           variant="filled"
                           severity="success"
